...
from network.SSAnetwork import SSANetG, SSANetD, weights_init, SSANetD2
...
class SSAGanomaly(nn.Module):
    ...
    def backward_g(self,x):
        ...
        self.err_g = self.err_g_adv * 1 + \
                     (self.err_g_con + self.err_g_ano_con)* 50 +\
                     self.err_g_enc * 1 + \
    ...
    def backward_d2(self):
        ...
        self.err_d_ano_fake = self.l_bce(self.pred_ano_fake, self.fake_label)
        # NetD Loss & Backward-Pass
        self.err_d2 = (self.err_d_ano_real + self.err_d_ano_fake) * 0.5
        self.err_d2.backward()
    ...
    def forward(self,x):
        ...
        return error_g, error_d, self.fake, self.netg, self.netd, self.err_g_attn, self.err_g_ano_attn, self.fake_attn
